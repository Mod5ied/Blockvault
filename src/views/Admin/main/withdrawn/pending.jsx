						...
						{pendingUsers.map((user, index) => {
							return (
								<span className={`flex flex-row w-full text-sm ${index % 2 === 0 ? "bg-gray-200" : "bg-white"}`}>
									...
									<div className="h-[63px] w-[25%] flex flex-col justify-between pl-6 py-1 ml-1 overflow-hidden">
										<h5 className="text-sm">{user.details[0]}</h5>
										<h5 className="text-sm">{user.details[1]}</h5>
										<h5 className="text-sm">{user.details[2]}</h5>
									</div>
									<div className="h-[63px] w-[20%] flex flex-col justify-between pl-6 py-1 ml-8 overflow-hidden">
										<h5> Wallet: {user.walletDetails.wallet} </h5>
										<h5>Wallet Address: {user.walletDetails.walletAddress} </h5>
									</div>
									<p className="h-[63px] w-[15%] flex items-center justify-between pl-6">{user.username}</p>
									<p className="h-[63px] w-[15%] flex items-center justify-between pl-6">{user.amount}</p>
									<p className="h-[63px] w-[10%] flex items-center justify-between pl-6">
