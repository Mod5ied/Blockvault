	...
	return (
		<div className="flex flex-col gap-4 items-center h-full bg-gray-100">
			<section className="w-full flex flex-row justify-between">
				<form onClick={handleSubmitPassword} >
			...
			<section className="w-full text-gray-100 py-5 px-8 rounded-md shadow-md bg-stone-900 flex flex-col gap-6;">
				...
				<span className="mt-4 flex flex-col gap-2">
					...
					<div className="flex flex-col gap-2">
						<button className="w-[12%] px-3 py-1 text-xs text-blue-600 rounded-md font-bold bg-stone-200">DISABLED</button>
						...
						<img src={qr_code} alt="qr_code" className="w-[18%] h-[100%]" />
						...
						<section className="w-[60%] flex flex-col gap-3">
							...
							<ReactSVG onClick={handleEnable} src={send} className="absolute left-[40%] mt-2 hover:text-green-600" />
						</section>
					</div>
				</span>
			</section>
